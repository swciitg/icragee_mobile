...
import 'package:icragee_mobile/widgets/lost_found/lost_or_found_details_card.dart';

import '../../shared/colors.dart';

class LostOrFoundItemCard extends StatelessWidget {
  final LostFoundModel item;
  final bool deleteOption;

  const LostOrFoundItemCard({
    super.key,
    required this.item,
            ...
            builder: (context) {
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    LostOrFoundDetailsCard(item: item),
                  ],
                ),
              );
            });
